Ext.define("LDPA.view.tablet.articles.ArticleDetails", {
    extend: 'Ext.Panel',
	...
	config: {
		...
		tpl: new Ext.XTemplate('' +
            '<div class="topbar" id="articleCategoryBackBtn{id}"></div>',
	...
	onSetActions: function(){
		...
		var btnComments = Ext.create("Ext.Button",{
			...
			name: 'articleCommentsBtn',
			itemId: 'articleCommentsBtn',
            iconCls: 'chat4',
            cls: "comments-button",
		...
		var btnShare = Ext.create("Ext.Button",{
			...
			name: 'articleShareBtn',
			itemId: 'articleShareBtn',
            iconCls: 'facebook',
            cls: "share-button",
		...
		var btnTweet = Ext.create("Ext.Button",{
			...
			name: 'articleTweetBtn',
			itemId: 'articleTweetBtn',
            iconCls: 'tweet',
            cls: "tweet-button",
		...
		var btnBack = Ext.create("Ext.Button",{
			...
			renderTo: document.getElementById('articleCategoryBackBtn'+articleId),
			name: 'articleBackBtn',
            iconCls: 'reply',
			itemId: 'articleBackBtn',
            cls: 'back-button',
