						...
						items: [
							{
								...
								handler: function(btn){
									...
									// online
										...
										window.open("http://www.facebook.com/sharer.php?u="+webUrl+"&t="+title, '_blank', 'location=yes');
									}
								},
								scope: this
							},
							{
								...
								handler: function(btn){
									...
									// online
										...
										window.open("http://www.twitter.com/?status="+title+"+"+webUrl, '_blank', 'location=yes');
									}
								},
								scope: this
							}
