...
Ext.define('LDPA.controller.tablet.Main', {
	...
	setActions: function(){
		...
		if (categoriesStore.isLoaded() || categoriesStore.getCount() > 0){
			...
			// Initialize the actions list
      		Ext.Viewport.add(Ext.create('LDPA.view.'+profile+'.actions.ActionsList', {zIndex: 1}));
			
			// Initialize the app panel
      		Ext.Viewport.add(Ext.create('LDPA.view.'+profile+'.AppPanel', {zIndex: 2}));
